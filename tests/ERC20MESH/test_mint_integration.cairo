...
func test_mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(delay: felt){
    ...
    %{ stop_warp_1 = warp(86400 * 365 + ids.delay_temp, target_contract_address=ids.erc20_mesh_address) %}
    ...
    %{ stop_warp_2 = warp(86400 * 372 + ids.delay_temp, target_contract_address=ids.erc20_mesh_address) %}
